...
class Apis {
    ...
    getVideos(title: string) {
        return this.getByUrl(`https://www.googleapis.com/youtube/v3/search?part=snippet&q=${title.replace(' ', '%20')}%20official%20trailer&type=video&key=${Y_KEY}&maxResults=1`, true)
